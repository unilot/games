...
contract('UnilotToken', function (accounts) {
    ...
    it('Check normal game flow', function() {
        ...
        return UnilotPrizeCalculator.deployed().then(function(instance) {
            ...
            return UnilotBonusTailToken.new(calculatorContract.address)
            ...
            return bonusGame.getNumPlayers.call()
        }).then(function (prizeAmount) {
            // console.log(prizeAmount.valueOf());
            // return assert.equal(web3.toWei(100000, 'ether'), prizeAmount.valueOf(),
